...
class CommentsFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $stock = [
            ["Merci Étienne pour ce moment de partage, d'échange sur le voyage et la musique et ça tombe bien car le son pur de ton instrument nous emmène ailleurs, là où tout est possible, dans un monde meilleur !", "Virginie", 47],
            ["C’était vraiment cool comme expérience. Quand on lâche vraiment prise et que l’on ferme les yeux, ça t’emporte vraiment loin. Mon corps se détendais, mes pieds lâchaient des pulsations tout seul c’était assez bizarre comme sensation. Je ressentais les vibrations dans ma colonne vertébrale et c’est vraiment agréable c’est comme une sorte de massage mais interne. Franchement c’est un instrument hyper intriguant mais hyper relaxant c’est vraiment sympa à découvrir et assez original. Bonne continuation !", "Anaïs", 18],
            ["Merci Étienne pour cette épatante et apaisante expérience sensorielle, un moment de pure relaxation, un bonheur pour les oreilles et pour le corps. Merci et bonne route !", "Marco", 36],
            ["Expérience extrêmement agréable. On entre très rapidement dans la détente et la relaxation s’installe. Le corps baigné dans la musique douce du handpan se sent bercé par dans harmonies apaisantes. Je vous invite à expérimenter ce moment hors du temps, très régénérant.", "Pascal", 59],
            ...
            ["J\’ai beaucoup aimé l\’instrument que Étienne nous as présenté, j'ai trouvé les sons de ce dernier très originaux. Ce pourquoi j’ai décidé de tenter l’expérience avec l’instrument sur le corps et c’est encore plus apaisant. Je conseille totalement de tester cette expérience sensorielle!", "Elisa", 18],
            ...
            ["Merci Etienne pour cette magnifique soirée à la maison en terrasse pleine de partage et de zenitude. Une soirée agréable à la découverte de ce magnifique instrument aux sons envoutants qui mènent à la relaxation dès les premières notes.", "Florence", 47],
            ["Merci Étienne pour ce moment de partage, d'échange sur le voyage et la musique et ça tombe bien car le son pur de ton instrument nous emmène ailleurs, là où tout est possible, dans un monde meilleur !", "Virginie", 47],
            ["Nous avons adoré le blind test 'Étienne à peu près'. C'est ludique, divertissant, de bonne longueur. Suffisamment pour qu'on soit impliqué dans le jeu mais pas trop long pour que ça devienne lassant. Le choix des catégories était très bien ainsi que les morceaux, ça convenait à la moyenne d'âge et suffisamment diversifié pour toucher tout le monde. En gros, c’était top !", "Virginie", 41],
            ["Dès les premières notes de Barbapapan sur ses soucoupes volantes musicales, nous avons tous été envoûtés, les adultes autant que les enfants. Ces sons magiques ne peuvent que vous transporter. Le handpan est un instrument fabuleux et bien qu'originaire du pays voisin, il reste très peu connu dans nos contrées et fascine beaucoup ceux qui le découvrent, autant que ceux qui le redécouvrent d'ailleurs. Le moment de douceur que nous a offert Barbapapan avec ses propres compos et ses reprises de musiques de film ou de séries restera gravé dans les mémoires du public de notre première scène ouverte. Merci à toi mystérieux enchanteur !", "Café de l'Eco'lette", 0],
            ["Nous avons eu de très bons retours sur votre prestation, beaucoup de personnes ont découvert le handpan. Vous avez su avec votre musique mélodieuse et avec  vos explications intéresser un public nombreux. Les membres du conseil d’administration ont beaucoup apprécié votre animation.", "Association Espoir de la Butte", 0],
        ];
        ...
        for ($i = 0; $i < count($stock); ++$i) {
            ...
            $commentaire->setRubrique($this->getReference('rubrique'.rand(0,2)));
